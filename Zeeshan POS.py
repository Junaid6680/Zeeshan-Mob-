...
# --- PDF Function (Updated with Your Number, Customer Number & Watermark) ---
def create_pdf(bill_no, cust_name, phone, items, bill_total, old_bal, paid_amt, is_only_payment=False):
    ...
    pdf.set_text_color(240, 240, 240) # Light grey color
    ...
    pdf.cell(95, 8, f"Cust Phone: {phone}", ln=True, align='R') # Customer Number
    pdf.ln(10)
